...
import com.example.moviesapp.di.apiInjections
import com.example.moviesapp.di.repositoriesInjection
import com.example.moviesapp.di.viewModelsInjection
...
class BaseApplication : Application() {
    ...
    private fun initialiseKoin() {
        startKoin {
            ...
            modules(listOf(apiInjections, viewModelsInjection, repositoriesInjection))
        }
    }
